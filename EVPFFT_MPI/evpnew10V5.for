...
c      COMMON/TESTCOND/UDOT(3,3),DSIM(3,3),SCAUCHY(3,3),SDEVIAT(3,3),
c     #       TOMTOT(3,3),DBAR5(5),DBAR6(6),DELT(3),DELTVOL3,TDOT,
c     #       DISGRADMACRO(3,3),DDISGRADMACRO(3,3),scauav(3,3),
c     #       DDISGRADMACROACUM(3,3),velmax(3),
c     #       IUDOT(3,3),IDSIM(6),ISCAU(6),ICTRL,NSTEPS
...
cw
c      COMMON/DATACRYST/DNCA(3,NSYSMX,NPHMX),DBCA(3,NSYSMX,NPHMX),
c     #       SCHCA(5,NSYSMX,NPHMX),
c     #       TAU(NSYSMX,3,NPHMX),HARD(NSYSMX,NSYSMX,NPHMX),
c     #       THET(NSYSMX,0:1,NPHMX),
c     #       NRS(NSYSMX,NPHMX),GAMD0(NSYSMX,NPHMX)
...
cw
c      COMMON/DATAMODES/TWSH(NSYSMX,NPHMX),NSM(NMODMX,NPHMX),
c     #       NMODES(NPHMX),NSYST(NPHMX),NTWMOD(NPHMX),NTWSYS(NPHMX),
c     #       ISECTW(NSYSMX,NPHMX),ICRYST(NPHMX)
...
c      COMMON/DATAPHASE/NPH,NELEM,IPHBOT,IPHTOP,NGR

      dimension NPH,NELEM,IPHBOT,IPHTOP,NGR
cw
c      COMMON/FGRID/WGT,CRSS(NSYSMX,2,NPTS1,NPTS2,NPTS3),
c     #     SG(3,3,NPTS1,NPTS2,NPTS3),
c     #     EDOTP(3,3,NPTS1,NPTS2,NPTS3),EPT(3,3,NPTS1,NPTS2,NPTS3),
c     #     SCH(5,NSYSMX,NPTS1,NPTS2,NPTS3),AG(3,3,NPTS1,NPTS2,NPTS3),
c     #     DISGRAD(3,3,NPTS1,NPTS2,NPTS3),
ccg
c     #     VELGRAD(3,3,NPTS1,NPTS2,NPTS3),
ccg
cct     #       VEL(3,NPTS1,NPTS2,NPTS3),TLOCAL(3,NPTS1,NPTS2,NPTS3),
c     #       JPHASE(NPTS1,NPTS2,NPTS3),JGRAIN(NPTS1,NPTS2,NPTS3)
ccw
...
cw
c      COMMON/IOFILES/ FILETEXT,FILECRYSPL,FILECRYSEL,FILEHIST,PROSA
c      COMMON/IOUNITS/ UR0,UR1,UR2,UR3,UR4,UR5,UR6,UW1,UW2
c      COMMON/MISCEL/  PI,JRAN

      dimension FILETEXT,FILECRYSPL,FILECRYSEL,FILEHIST,PROSA
      dimension UR0,UR1,UR2,UR3,UR4,UR5,UR6,UW1,UW2
      dimension  PI,JRAN
cw
c      COMMON/RUNCOND/ERROR,FACT2,ITMAX,IRECOVER,ISAVE,IWTEX,IWDEQ
...
c      COMMON/PPC/SVM,DVM,EVM,ERRS,ERRE,ERRE2,IUPDATE,IUPHARD,
c     #           igas(nphmx),IWFIELDS,IWSTEP

ccg      COMMON/ELAS/cc(3,3,3,3),c0(3,3,3,3),s0(3,3,3,3),
c      COMMON/ELAS/cc(3,3,3,3,NPHMX),c0(3,3,3,3),s0(3,3,3,3),
c     #            cg66(6,6,NPTS1,NPTS2,NPTS3),c066(6,6)

c      COMMON/HARD/GAMDOT(NSYSMX,NPTS1,NPTS2,NPTS3),
c     #            GACUMGR(NPTS1,NPTS2,NPTS3),
c     #            TRIALTAU(NSYSMX,2,NPTS1,NPTS2,NPTS3)
ccth
c     #            ,XKIN(NSYSMX,NPTS1,NPTS2,NPTS3)
...
cth
cg
c      COMMON/BUF/WPH1,SCAUAV1(3,3),SVM1
ccth
c      COMMON/THER/ETH(3,3,1118),ITHERMO
...
cth
      dimension ETH(3,3,Num_Crystals),ITHERMO
       ...
       dimension B(3,3,6)
c       dimension CE2_5(5),C2(3,3),CE4_5(5,5)
c     #,C4(3,3,3,3),CE2_6(6),CE4_6(6,6),
c     #C4_VOIGT(3,3,3,3)


c      DIMENSION c2_VOIGT(6,6),IJV(6,2),F(6,6)
c      DATA ((IJV(N,M),M=1,2),N=1,6)/1,1,2,2,3,3,2,3,1,3,1,2/

#ifdef MPI
      dimension sg_gathered(3,3,NPTS1,NPTS2,NPTS3),
     ...
     #     TRIALTAU_gathered(NSYSMX,2,NPTS1,NPTS2,NPTS3) 
      ...
      MODULE VOIGT_MODULE
      Contains
      SUBROUTINE VOIGT(C2_VOIGT,C4_VOIGT,IOPT)
      USE fft_dim_MODULE
C
...
C
       ...
       DIMENSION c2_VOIGT(6,6),IJV(6,2),F(6,6),C4_VOIGT(3,3,3,3)
...
C
   ...
   10 C4_VOIGT(I2,I1,J2,J1)=c2_VOIGT(I,J)
      ENDIF
C
      IF(IOPT.EQ.2) THEN
      DO 20 I=1,6
      ...
      J1=IJV(J,1)
      J2=IJV(J,2)
   20 c2_VOIGT(I,J)=C4_VOIGT(I1,I2,J1,J2)
      ENDIF
c      
      IF(IOPT.EQ.3) THEN
      DO 9 I=1,6
...
101   C4_VOIGT(I2,I1,J2,J1)=F(I,J)*c2_VOIGT(I,J)
      ENDIF
C
      IF(IOPT.EQ.4) THEN
      DO 17 I=1,6
...
c      PARAMETER (RSQ2=0.70710678118654744)
c      PARAMETER (RSQ3=0.57735026918962584)
c      PARAMETER (RSQ6=0.40824829046386304)
...
C     IOPT=4: CALCULATES MATRIX COMPONENTS CE4(K,K) OF TENSOR 'C4'.
C **************************************************************************
      MODULE CHG_basic_6_MODULE
      contains
      SUBROUTINE CHG_BASIS_6(CE2_6,C2,CE4_6,C4,IOPT)
      USE fft_dim_MODULE
c      PARAMETER (SQR2=1.41421356237309   )
c      PARAMETER (RSQ2=0.70710678118654744)
c      PARAMETER (RSQ3=0.57735026918962584)
...
c      DIMENSION CE2(KDIM),C2(3,3),CE4(KDIM,KDIM),C4(3,3,3,3)
      dimension CE2_5(5),C2(3,3),CE4_5(5,5)
     #,C4(3,3,3,3),CE2_6(6),CE4_6(6,6) 
...
C *** CALCULATES CARTESIAN SECOND ORDER TENSOR FROM b-COMPONENTS VECTOR.
      IF(IOPT.EQ.1) THEN
        ...
        C2(I,J)=0.0
        DO 40 N=1,6
   40   C2(I,J)=C2(I,J)+CE2_6(N)*B(I,J,N)
      ENDIF
...
C *** CALCULATES KDIMx1 b-COMPONENTS VECTOR FROM SECOND ORDER TENSOR.
      IF(IOPT.EQ.2) THEN
        ...
        DO 50 I=1,3
        DO 50 J=1,3
   50   CE2_6(N)=CE2_6(N)+C2(I,J)*B(I,J,N)
      ENDIF
...
C *** CALCULATES FOURTH ORDER TENSOR FROM b-COMPONENTS MATRIX.
      IF(IOPT.EQ.3) THEN
        ...
        DO 20 N=1,6
        DO 20 M=1,6
   20   C4(I,J,K,L)=C4(I,J,K,L)+CE4_6(N,M)*B(I,J,N)*B(K,L,M)
      ENDIF
...
C *** CALCULATES KDIMxKDIM b-COMPONENTS MATRIX FROM FOURTH ORDER TENSOR.
      IF(IOPT.EQ.4) THEN
        ...
        DO 30 K=1,3
        DO 30 L=1,3
   30   CE4_6(N,M)=CE4_6(N,M)+C4(I,J,K,L)*B(I,J,N)*B(K,L,M)
      ENDIF

      RETURN
      END SUBROUTINE CHG_BASIS_6 
      END MODULE CHG_basic_6_MODULE
...
C     IOPT=4: CALCULATES MATRIX COMPONENTS CE4(K,K) OF TENSOR 'C4'.
C **************************************************************************
      MODULE CHG_basic_5_MODULE
      contains
      SUBROUTINE CHG_BASIS_5(CE2_5,C2,CE4_5,C4,IOPT)
      USE fft_dim_MODULE
c      PARAMETER (SQR2=1.41421356237309   )
c      PARAMETER (RSQ2=0.70710678118654744)
c      PARAMETER (RSQ3=0.57735026918962584)
...
C *** CALCULATES CARTESIAN SECOND ORDER TENSOR FROM b-COMPONENTS VECTOR.
      IF(IOPT.EQ.1) THEN
        ...
        C2(I,J)=0.0
        DO 40 N=1,5
   40   C2(I,J)=C2(I,J)+CE2_5(N)*B(I,J,N)
      ENDIF
...
C *** CALCULATES KDIMx1 b-COMPONENTS VECTOR FROM SECOND ORDER TENSOR.
      IF(IOPT.EQ.2) THEN
        ...
        DO 50 I=1,3
        DO 50 J=1,3
   50   CE2_5(N)=CE2_5(N)+C2(I,J)*B(I,J,N)
      ENDIF
...
C *** CALCULATES FOURTH ORDER TENSOR FROM b-COMPONENTS MATRIX.
      IF(IOPT.EQ.3) THEN
        ...
        DO 20 N=1,5
        DO 20 M=1,5
   20   C4(I,J,K,L)=C4(I,J,K,L)+CE4_5(N,M)*B(I,J,N)*B(K,L,M)
      ENDIF
...
C *** CALCULATES KDIMxKDIM b-COMPONENTS MATRIX FROM FOURTH ORDER TENSOR.
      IF(IOPT.EQ.4) THEN
        ...
        DO 30 K=1,3
        DO 30 L=1,3
   30   CE4_5(N,M)=CE4_5(N,M)+C4(I,J,K,L)*B(I,J,N)*B(K,L,M)
      ENDIF

      RETURN
      END SUBROUTINE CHG_BASIS_5 
      END MODULE CHG_basic_5_MODULE



       
      MODULE kinhard_param_MODULE
      contains
      subroutine kinhard_param
c      USE CHG_basic_MODULE
      USE CHG_basic_6_MODULE
      USE CHG_basic_5_MODULE
      USE fft_dim_MODULE
      ...
      do 7277 k=1,npts3
       ...
       if(igas(jph).eq.0) then
        ...
        enddo
c
c        call chg_basis(sg5,sgx,aux55,aux3333,2,5)
#ifdef MPI
#ifdef Barrier
       ...
       call CPU_TIME(t24)
#endif   
         call chg_basis_5(sg5,sgx,aux55,aux3333,2)
#ifdef MPI
#ifdef Barrier
       call MPI_BARRIER(MPI_COMM_WORLD,ierr) 
#endif
       ...
       call CPU_TIME(t25)
#endif 
       sum_chg_basis_in_main=sum_chg_basis_in_main+(t25-t24)
c
        do is=1,nsyst(jph)
...
c
      return
      END subroutine kinhard_param
      END MODULE kinhard_param_MODULE
...
C
     ...
     #              DNCA(j,NSYSX,IPH)*DBCA(i,NSYSX,IPH))/2.
      ...
      ENDDO
c
c      call chg_basis(aux5,aux33,aux55,aux3333,2,5)
#ifdef MPI
#ifdef Barrier
       call MPI_BARRIER(MPI_COMM_WORLD,ierr) 
#endif
       ...
       call chg_basis_5(aux5,aux33,aux55,aux3333,2)
#ifdef MPI
#ifdef Barrier
       call MPI_BARRIER(MPI_COMM_WORLD,ierr) 
#endif
       ...
       call CPU_TIME(t27)
#endif 
       sum_chg_basis_in_main=sum_chg_basis_in_main+(t27-t26)
c
      DO I=1,5
...
C
      RETURN
      END SUBROUTINE DATA_CRYSTAL
      END MODULE Data_Crystal_MODULE
...
c
      RETURN
      END SUBROUTINE DATA_CRYSTAL_ELAST 
      END MODULE DATA_CRYSTAL_ELAST_MODULE
...
1     continue
c
c      call chg_basis(aux6,aux33,caux66,caux3333,4,6)
#ifdef MPI
#ifdef Barrier
       call MPI_BARRIER(MPI_COMM_WORLD,ierr) 
#endif
       ...
       call chg_basis_6(aux6,aux33,caux66,caux3333,4)
       ...
       call CPU_TIME(t29)
#endif 
       sum_chg_basis_in_main=sum_chg_basis_in_main+(t29-t28)
c
      do i=1,6
      do j=1,6
...
C
c      call chg_basis(aux6,aux33,c066,c0,3,6)
c      call chg_basis(aux6,aux33,s066,s0,3,6)
      call chg_basis_6(aux6,aux33,c066,c0,3)
      call chg_basis_6(aux6,aux33,s066,s0,3)
c
      RETURN
      END SUBROUTINE DATA_GRAIN
      END MODULE Data_Grain_MODULE
...
C *****************************************************************************
C
      MODULE VPSC_INPUT_MODULE
      contains
      SUBROUTINE VPSC_INPUT
      USE VOIGT_MODULE
      USE DATA_CRYSTAL_ELAST_MODULE
      USE Data_Crystal_MODULE
      USE Data_Grain_MODULE
c      USE CHG_basic_MODULE
      USE CHG_basic_6_MODULE
      USE CHG_basic_5_MODULE
      USE fft_dim_MODULE
...
c      CALL CHG_BASIS(AUX6,AUX33,AUX66,AUX3333,0,6)
       CALL CHG_BASIS_6(AUX6,AUX33,AUX66,AUX3333,0)
C
...
c
      ...
      OPEN (unit=UR1,file='cupl2.txt',status='old')
        call data_crystal(iph)
      CLOSE(unit=UR1)
cevp
      OPEN (unit=UR1,file='cuel2.txt',status='old')
...
c
      OPEN(unit=UR2,file='txfft.txt',status='old')
        call data_grain
      CLOSE(unit=UR2)
ccc
...
c
c      call chg_basis(dbar6,dsim,aux66,aux3333,2,6)
       call chg_basis_6(dbar6,dsim,aux66,aux3333,2)

      do i=1,5
      dbar5(i)=dbar6(i)
      enddo

c      call chg_basis(dbar5,dsimdev,aux55,aux3333,1,5)
       call chg_basis_5(dbar5,dsimdev,aux55,aux3333,1)
c
      dvm=0.
      do i=1,3
      do j=1,3
...
cth
      RETURN
      END SUBROUTINE VPSC_INPUT
      END MODULE VPSC_INPUT_MODULE
...
c
      ...
      enddo
c
c      call chg_basis(aux5,aux33,aux55,aux3333,1,5)
       call chg_basis_5(aux5,aux33,aux55,aux3333,1)
c 
      do 140 i=1,3
      do 140 j=1,3
        aux33r(i,j)=0.
...
140   continue
c
c      call chg_basis(aux5,aux33r,aux55,aux3333,2,5)
       call chg_basis_5(aux5,aux33r,aux55,aux3333,2)
c
      do j=1,5
...
c
     ...
     #   (EXPDEL*((GAMTOTX+DELTGAM)*FACT+1.)-(GAMTOTX*FACT+1.))
      ...
      RETURN
      END subroutine get_trialtau
      END MODULE Get_trialtau_MODULE
...
c      USE CHG_basic_MODULE
      ...
      USE CHG_basic_5_MODULE
      USE LU_inverse_MODULE
      USE Edost_sg_Eval_MODULE
      USE Get_trialtau_MODULE
      USE fft_dim_MODULE
#ifdef MPI
      USE mpi
#endif
...
cg        disgradaux(ii,jj)=disgrad(ii,jj,i,j,k)
       ...
       enddo
c
c      call chg_basis(xlambda6,xlambda,aux66,aux3333,2,6)

c      call chg_basis(sg6,sgaux,aux66,aux3333,2,6)
c      call chg_basis(ept6,eptaux,aux66,aux3333,2,6)
ccg      call chg_basis(disgrad6,disgradaux,aux66,aux3333,2,6)
c      call chg_basis(strain6,strainaux,aux66,aux3333,2,6)
c

      call chg_basis_6(xlambda6,xlambda,aux66,aux3333,2)

      call chg_basis_6(sg6,sgaux,aux66,aux3333,2)
      call chg_basis_6(ept6,eptaux,aux66,aux3333,2)
cg      call chg_basis(disgrad6,disgradaux,aux66,aux3333,2,6)
      call chg_basis_6(strain6,strainaux,aux66,aux3333,2)
...
c      call chg_basis(strainceq6,strainceq,aux66,aux3333,1,6)
       call chg_basis_6(strainceq6,strainceq,aux66,aux3333,1)
...
c
c      call chg_basis(sg6,sgaux,aux66,aux3333,1,6)
c      call chg_basis(edotp6,edotpaux,aux66,aux3333,1,6)

      call chg_basis_6(sg6,sgaux,aux66,aux3333,1)
      call chg_basis_6(edotp6,edotpaux,aux66,aux3333,1)
...
cx      pause
      ...
      END Module Evpal_MODULE
      
      
c
 
      MODULE Get_Smacro_MODULE
      contains
...
c      call chg_basis(sav6,scauav,aux66,aux3333,2,6)
       call chg_basis_6(sav6,scauav,aux66,aux3333,2)
c
      do ii=1,5
      sav5(ii)=sav6(ii)
      enddo
c
c      call chg_basis(sav5,sdeviat,aux55,aux3333,1,5)
      call chg_basis_5(sav5,sdeviat,aux55,aux3333,1)
c
      svm=0.
      do i=1,3
      do j=1,3
      ...
      svm=sqrt(3./2.*svm)
cg
c      call chg_basis(sav6,scauav1,aux66,aux3333,2,6)
      call chg_basis_6(sav6,scauav1,aux66,aux3333,2)
      do ii=1,5
      sav5(ii)=sav6(ii)
      enddo
c      call chg_basis(sav5,sdeviat,aux55,aux3333,1,5)
...
cc      pause
      ...
      END MODULE Get_Smacro_MODULE
      
      
C *****************************************************************************
c     HARDEN   HARDEN    HARDEN   HARDEN   HARDEN    HARDEN  HARDEN   HARDEN         
...
C
      RETURN
      END function tnorm
      END MODULE Tnorm_MODULE
 
      MODULE Orient_MODULE
      contains
...
90    a(i,j)=anew(i,j)
      ...
      END MODULE Orient_MODULE
      
            MODULE Update_Orient_MODULE
      contains
...
c
      ...
      END MODULE Update_Orient_MODULE
...
C
      RETURN
      END FUNCTION tmismatch 
      END MODULE Tmismatch_MODULE
    
       

C
       
            MODULE LU_Eqsystem_MODULE
      contains
...
c
      ...
      USE fourn_MODULE
      USE VPSC_INPUT_MODULE 
      USE EULER_MODULE
c      USE CHG_basic_MODULE 
      USE CHG_basic_6_MODULE
      USE CHG_basic_5_MODULE
      USE Update_Schmid_MODULE
      USE LU_inverse_MODULE
      USE Evpal_MODULE
      USE Minval_MODULE
      USE Get_Smacro_MODULE
      USE Update_Orient_MODULE
      USE Harden_MODULE
      USE kinhard_param_MODULE
      USE vm_MODULE
...
c
      ...
      dimension xk(3),xk2(3),xk_gb(3,npts1,npts2,npts3)
...
c      call chg_basis(aux6,aux33,cg66aux,cg,3,6)
       ...
       call CPU_TIME(t20)
#endif 
       call chg_basis_6(aux6,aux33,cg66aux,cg,3)
#ifdef MPI
#ifdef Barrier
       call MPI_BARRIER(MPI_COMM_WORLD,ierr) 
#endif
       ...
       call CPU_TIME(t21)
#endif 
       sum_chg_basis_in_main=sum_chg_basis_in_main+(t21-t20)
...
7771  continue
      ...
      if(imicro.eq.1.or.iupdate.eq.1) call update_schmid
       ...
       call CPU_TIME(t12)
#endif
      sum_update_schmid=sum_update_schmid+(t12-t11)
...
c
      ...
      xk_gb(1,kxx,kyy,kzz)=xk(1)
      xk_gb(2,kxx,kyy,kzz)=xk(2)
      xk_gb(3,kxx,kyy,kzz)=xk(3)
c
...
c      call chg_basis(aux6,aux33,cg66aux,cinvg,3,6)
#ifdef MPI
#ifdef Barrier
       call MPI_BARRIER(MPI_COMM_WORLD,ierr) 
#endif
       ...
       call CPU_TIME(t22)
#endif 
       call chg_basis_6(aux6,aux33,cg66aux,cinvg,3)
       ...
       call CPU_TIME(t23)
#endif 
       sum_chg_basis_in_main=sum_chg_basis_in_main+(t23-t22)
...
ccc
       ...
       print*,"----------------------------"
       print*,"update_schmid time:",sum_update_schmid
       print*,"----------------------------"
       print*,"sum_chg_basis_in_main time:",sum_chg_basis_in_main
       print*,"----------------------------"
       print*,"Evpal portion:",sum_evpal/(t2-t1)*100,"%"
       print*,"----------------------------"
       print*,"FFT portion:",sum_Fourn/(t2-t1)*100,"%"
       print*,"----------------------------"
       print*,"update_schmid portion:",sum_update_schmid/(t2-t1)*100,"%"
       print*,"----------------------------"
